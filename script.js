...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const Timer = () => {
        ...
        // The sound ding() is imported at the end of the script as base64.
        const startDing = () => {
            clockInterval = setInterval(ding, 250)
            timerControls.classList.add('hidden')
        ...
        const start = () => {
            ...
            const updateTicks = () => {
                ...
                else clearTimer(), hours = minutes = seconds = 0, startDing()
    ...
    document.addEventListener('click', (e) => {
        ...
        if (targetId === 'reset-timer-end') renderTimer()
    })
